      ...
      <div className="svc-header relative z-10 max-w-[1400px] w-full mx-auto px-5 md:px-10 pb-6 !pt-0">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          <div className="flex items-center gap-3 mt-6 md:mt-0 shrink-0">
            <button
              onClick={() => scroll("left")}
              className="w-12 h-12 rounded-full border border-navy/15 flex items-center justify-center text-navy hover:bg-primary hover:border-primary hover:text-white transition-all duration-300"
